...
node scripts/smoke-v94.js
```

La prueba `smoke-v94.js` valida prioridad de reglas personales, cálculo línea por línea, protección de pedidos fuera del rango solicitado y el recálculo de precio al reemplazar productos.

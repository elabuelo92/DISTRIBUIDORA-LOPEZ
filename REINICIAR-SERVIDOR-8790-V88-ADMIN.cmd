@echo off
title Reiniciar Distribuidora Lopez 8790 v88
net session >nul 2>&1
if not "%errorlevel%"=="0" (
...
echo.
echo ============================================================
echo  Reinicio controlado SERVIDOR_UNICO_8790 v88
echo ============================================================
echo.
...
echo.
echo Iniciando servidor v88...
start "Distribuidora Lopez 8790 v88" powershell.exe -NoProfile -ExecutionPolicy Bypass -NoExit -File "%~dp0scripts\run-server-prod.ps1"
echo.
echo Validar en:

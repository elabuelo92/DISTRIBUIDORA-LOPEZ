...
assert.match(index, /app\.js\?v=8790-141-r20260907c/);
assert.match(index, /styles\.css\?v=8790-141-r20260907c/);
assert.match(worker, /distribuidora-lopez-servidor-unico-8790-v141/);
...
console.log(JSON.stringify({ ok: true, version: "8790-141", automaticReload: true, noStore: true, workerSkipWaiting: true }, null, 2));

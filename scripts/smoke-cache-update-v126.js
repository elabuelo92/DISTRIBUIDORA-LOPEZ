...
assert.match(config, /VERSION: "8790-145"/);
assert.match(index, /app\.js\?v=8790-145-r20260915b/);
assert.match(index, /styles\.css\?v=8790-145-r20260915b/);
assert.match(worker, /distribuidora-lopez-servidor-unico-8790-v145/);
...
console.log(JSON.stringify({ ok: true, version: "8790-145", automaticReload: true, noStore: true, workerSkipWaiting: true }, null, 2));

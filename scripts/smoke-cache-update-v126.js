...
assert.match(index, /app\.js\?v=8790-132-r20260905b/);
assert.match(index, /styles\.css\?v=8790-132-r20260905b/);
assert.match(worker, /distribuidora-lopez-servidor-unico-8790-v132/);
...
console.log(JSON.stringify({ ok: true, version: "8790-132", automaticReload: true, noStore: true, workerSkipWaiting: true }, null, 2));

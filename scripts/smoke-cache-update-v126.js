...
assert.match(config, /VERSION: "8790-148"/);
assert.match(index, /app\.js\?v=8790-148-r20260916a/);
assert.match(index, /styles\.css\?v=8790-148-r20260916a/);
assert.match(worker, /distribuidora-lopez-servidor-unico-8790-v148/);
...
console.log(JSON.stringify({ ok: true, version: "8790-148", automaticReload: true, noStore: true, workerSkipWaiting: true }, null, 2));

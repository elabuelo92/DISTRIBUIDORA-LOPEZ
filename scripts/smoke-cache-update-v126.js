...
assert.match(index, /app\.js\?v=8790-134-r20260905d/);
assert.match(index, /styles\.css\?v=8790-134-r20260905d/);
assert.match(worker, /distribuidora-lopez-servidor-unico-8790-v134/);
...
console.log(JSON.stringify({ ok: true, version: "8790-134", automaticReload: true, noStore: true, workerSkipWaiting: true }, null, 2));

...
assert.match(index, /app\.js\?v=8790-128-r20260902b/);
assert.match(index, /styles\.css\?v=8790-128-r20260902b/);
assert.match(worker, /distribuidora-lopez-servidor-unico-8790-v128/);
...
console.log(JSON.stringify({ ok: true, version: "8790-128", automaticReload: true, noStore: true, workerSkipWaiting: true }, null, 2));

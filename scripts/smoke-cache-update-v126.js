...
assert.match(index, /app\.js\?v=8790-133-r20260905c/);
assert.match(index, /styles\.css\?v=8790-133-r20260905c/);
assert.match(worker, /distribuidora-lopez-servidor-unico-8790-v133/);
...
console.log(JSON.stringify({ ok: true, version: "8790-133", automaticReload: true, noStore: true, workerSkipWaiting: true }, null, 2));

...
assert.match(index, /app\.js\?v=8790-135-r20260906a/);
assert.match(index, /styles\.css\?v=8790-135-r20260906a/);
assert.match(worker, /distribuidora-lopez-servidor-unico-8790-v135/);
...
console.log(JSON.stringify({ ok: true, version: "8790-135", automaticReload: true, noStore: true, workerSkipWaiting: true }, null, 2));

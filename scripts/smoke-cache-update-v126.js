...
assert.match(config, /VERSION: "8790-146"/);
assert.match(index, /app\.js\?v=8790-146-r20260915c/);
assert.match(index, /styles\.css\?v=8790-146-r20260915c/);
assert.match(worker, /distribuidora-lopez-servidor-unico-8790-v146/);
...
console.log(JSON.stringify({ ok: true, version: "8790-146", automaticReload: true, noStore: true, workerSkipWaiting: true }, null, 2));

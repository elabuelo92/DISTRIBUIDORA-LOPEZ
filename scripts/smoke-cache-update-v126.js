...
assert.match(config, /VERSION: "8790-149"/);
assert.match(index, /app\.js\?v=8790-149-r20260917a/);
assert.match(index, /styles\.css\?v=8790-149-r20260917a/);
assert.match(worker, /distribuidora-lopez-servidor-unico-8790-v149/);
...
console.log(JSON.stringify({ ok: true, version: "8790-149", automaticReload: true, noStore: true, workerSkipWaiting: true }, null, 2));

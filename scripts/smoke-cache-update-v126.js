...
assert.match(index, /app\.js\?v=8790-130-r20260902c/);
assert.match(index, /styles\.css\?v=8790-130-r20260902c/);
assert.match(worker, /distribuidora-lopez-servidor-unico-8790-v130/);
...
console.log(JSON.stringify({ ok: true, version: "8790-130", automaticReload: true, noStore: true, workerSkipWaiting: true }, null, 2));

...
assert.match(config, /VERSION: "8790-144"/);
assert.match(index, /app\.js\?v=8790-144-r20260915a/);
assert.match(index, /styles\.css\?v=8790-144-r20260915a/);
assert.match(worker, /distribuidora-lopez-servidor-unico-8790-v144/);
...
console.log(JSON.stringify({ ok: true, version: "8790-144", automaticReload: true, noStore: true, workerSkipWaiting: true }, null, 2));

...
assert.match(index, /app\.js\?v=8790-131-r20260905a/);
assert.match(index, /styles\.css\?v=8790-131-r20260905a/);
assert.match(worker, /distribuidora-lopez-servidor-unico-8790-v131/);
...
console.log(JSON.stringify({ ok: true, version: "8790-131", automaticReload: true, noStore: true, workerSkipWaiting: true }, null, 2));

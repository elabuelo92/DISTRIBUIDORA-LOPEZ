...
assert.match(config, /VERSION: "8790-153"/);
assert.match(index, /app\.js\?v=8790-153-r[0-9a-z]+/);
assert.match(index, /styles\.css\?v=8790-153-r[0-9a-z]+/);
assert.match(worker, /distribuidora-lopez-servidor-unico-8790-v153/);
...
console.log(JSON.stringify({ ok: true, version: "8790-153", automaticReload: true, noStore: true, workerSkipWaiting: true }, null, 2));

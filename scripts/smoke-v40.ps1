...
try {
  ...
  try {
    ...
    foreach ($pattern in @("8790-40", "orderTimelineDialog", "Trazabilidad completa")) {
  ...
  Write-Host ""
  Write-Host "Resultado: smoke v40 OK." -ForegroundColor Green
  exit 0
} finally {
  Pop-Location
}
